...
BG = pygame.transform.scale(pygame.image.load("public/bg.jpeg"),(WIDTH, HEIGHT))
...
def main():
    ...
    star_count = 0 #When we should add a star
    ...
    while run:
        star_count += clock.tick(60) #Returns number of millisecnds since the last clock tick
